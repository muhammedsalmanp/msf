...
import {addProgram,getProgram} from '../controllers/CO/programController.js'


import { verifyAccessToken } from '../middleware/verification.js';
import upload from '../config/multerConfig.js';

import { deleteProgramController } from '../controllers/userController/Program/deleteProgramController.js';
import { getmsfCommitteeUsersByUnit, deleteUserFromCommittee, changeUserRoleInCommittee, addUserToCommittee, getCommitteeUsersByUnit, updateUserInCommittee, updateCommitteeAndUserRoles } from '../controllers/userController/Commetti.js';
...
router.delete("/programs/:id", verifyAccessToken, deleteProgramController);
