...
import { addProgram, updateProgram, deleteProgram ,getProgramList} from '../controllers/CO/programController.js';
...
router.get("/programs/list", verifyAccessToken, getProgramList);
//=============Committe====================
