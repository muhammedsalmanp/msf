...
const EditCommittee = ({ unitId, committeeType, members, onBack }) => {
  ...
  // const [selectedMember, setSelectedMember] = useState(null); // This seems unused for AddUserModal
  ...
  // ✅ Simplified confirmation modal state (now ONLY for delete)
  ...
  const handleAddUserClick = () => {
    // setSelectedMember(null); // Unnecessary if AddUserModal doesn't use it
    setIsModalOpen(true);
  };
  ...
  // ✅ New handler to open the Change Role modal
  const handleChangeRoleClick = (member) => {
    setMemberToChangeRole(member);
    setIsChangeRoleModalOpen(true);
  };

  // ✅ New handler to open ONLY the delete confirmation
  ...
  return (
    <div className="max-w-5xl mx-auto mt-10 bg-white rounded-xl shadow-lg p-6 sm:p-8 font-sans">
      {/* Header */}
