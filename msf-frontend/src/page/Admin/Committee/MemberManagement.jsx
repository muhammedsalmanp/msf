...
const MemberManagement = () => {
  ...
  const handleApply = async () => {
    dispatch(setLoading(true));
    try {
      // --- UPDATED: No filter, send entire selectedUnits list ---
      ...
      dispatch(
        showNotification({
          type: "success",
          // --- UPDATED: Changed success message ---
  ...
  return (
    <div className="p-4 md:p-8">
            ...
            {members.length === 0 ? (
              ...
              members.map((m) => (
                ...
                >
                  ...
                  <td className="p-4">{m.username ? m.username : m.phone}</td>
                  <td className="p-4">
                    {m.roles
                  ...
                  <td className="p-4 text-center">
                    <div className="flex items-center justify-center gap-2">
                      ...
                      {/* UPDATED: Calls the new modal function */}
                      <button
      ...
      {/* Assign In-Charge Modal (Unchanged) */}
      {isAssignModalOpen && (
              ...
              {units.length > 0 ? (
                units.map((unit) => (
                  ...
                  >
                    ...
                    {/* --- UPDATED: Removed disabled and complex className --- */}
                    <input
                      type="checkbox"
      ...
      {/* View All In-Charge Units Modal (Unchanged) */}
      {isViewModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50 backdrop-blur-sm bg-black/30">
      ...
      {isPasswordModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50 backdrop-blur-sm bg-black/30">
          <div className="bg-white rounded-lg shadow-lg w-11/12 max-w-sm p-6">
            ...
            <div className="flex justify-end gap-3 mt-5">
              <button
                nbsp onClick={closePasswordModal}
                className="px-4 py-2 text-gray-600 border rounded-md hover:bg-gray-100 transition"
              >
                Cancel
              </button>
      ...
      {/* --- NEW: Delete Confirmation Modal (Unchanged, logic is updated in function) --- */}
      {isDeleteModalOpen && (
        <div className="fixed inset-0 flex items-center justify-center z-50 backdrop-blur-sm bg-black/30">
          <div className="bg-white rounded-lg shadow-lg w-11/12 max-w-sm p-6">
