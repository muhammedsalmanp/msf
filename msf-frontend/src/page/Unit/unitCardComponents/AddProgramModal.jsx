...
//           existingImagesToKeep: selectedImages.filter(img => img.status === 'existing').map(img => img.key), // Send keys/URLs
...
const AddProgramModal = ({
    mode = 'add',
    initialData = null, // Used to load existing images
    onClose,
    onSubmit, // This is the PARENT's submit function
    data = { name: '', date: '', description: '' }, // Holds text input values from parent
    onFormChange, // This is the PARENT's handler for text inputs
