...
//                   <span className="px-4 text-green-400 font-semibold text-lg">
//                     Vice Presidents
//                   </span>
//                   <div className="flex-grow border-t border-green-300"></div>
//                 </div>
//                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-10">
//                   {committee.vicePresidents.map((vp, idx) => (
//                     <div
//                       key={idx}
//                       className="flex items-center space-x-2 pl-[20%] lg:pl-20"
//                     >
//                       <FaCircle className="w-4 h-4 text-green-600" />
//                       <span className="text-gray-800 font-medium">{vp.name}</span>
//                     </div>
//                   ))}
//                 </div>
//               </div>
...
//                 </div>
//                 <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-10">
//                   {committee.jointSecretaries.map((js, idx) => (
//                     <div
//                       key={idx}
//                       className="flex items-center space-x-2 pl-[20%] lg:pl-20"
//                     >
//                       <FaCircle className="w-4 h-4 text-green-600" />
//                       <span className="text-gray-800 font-medium">{js.name}</span>
//                     </div>
//                   ))}
//                 </div>
//               </div>
