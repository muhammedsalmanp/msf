...
// import { FaUserTie, FaUserTag, FaMapMarkerAlt, FaUsers } from 'react-icons/fa'; 
...
//       try {
//         const res = await axios.get("/user/main-members");
//         setMembers(res.data);
//       } catch (err) {
//         console.error('Error fetching main members:', err);
//       }
//     };
//     fetchMembers();
//   }, []);
...
//     memberList.find((m) => 
//       m.roles.some((r) => r.scope === "main" && r.role?.title === roleTitle)
//     );
...
//         {renderGroup('', [
//           findByRole(maleMembers, "President"),
//           findByRole(maleMembers, "Secretary"),
//           findByRole(maleMembers, "Treasurer")
//         ].filter(Boolean))} 

//         {renderGroup('Vice Presidents', maleMembers.filter((m) =>
//           m.roles.some((r) => r.scope === "main" && r.role?.title?.includes("Vice President"))
//         ))}
//         {renderGroup('Joint Secretaries', maleMembers.filter((m) =>
//           m.roles.some((r) => r.scope === "main" && r.role?.title?.includes("Joint Secretary"))
//         ))}
//         {renderGroup('Wing', maleMembers.filter((m) =>
//           m.roles.some((r) => r.scope === "main" && r.role?.title?.includes("Wing"))
//         ))}
        
//         {renderGroup('Executive Members', maleMembers.filter((m) =>
...
//         {renderGroup('', [
//           findByRole(femaleMembers, "President"),
//           findByRole(femaleMembers, "Secretary"),
//           findByRole(femaleMembers, "Treasurer")
//         ].filter(Boolean))}

//         {renderGroup('Vice Presidents', femaleMembers.filter((m) =>
//           m.roles.some((r) => r.scope === "main" && r.role?.title?.includes("Vice President"))
//         ))}
//         {renderGroup('Joint Secretaries', femaleMembers.filter((m) =>
//           m.roles.some((r) => r.scope === "main" && r.role?.title?.includes("Joint Secretary"))
//         ))}
//         {renderGroup('Wing', femaleMembers.filter((m) =>
//           m.roles.some((r) => r.scope === "main" && r.role?.title?.includes("Wing"))
//         ))}

//         {renderGroup('Executive Members', femaleMembers.filter((m) =>
//           m.roles.some((r) => r.scope === "main" && r.role?.title?.toLowerCase().includes("executive"))
//         ))}
//       </div>
//     </section>
